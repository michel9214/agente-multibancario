...
class _CreateEntityScreenState extends ConsumerState<CreateEntityScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      await ref.read(entitiesProvider.notifier).create(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Nueva Entidad')),
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: const [
                  ...
                  DropdownMenuItem(value: 'INTERMEDIARY', child: Text('Intermediario')),
              ...
              Wrap(
                ...
                children: _colors.map((c) {
                  final color = Color(int.parse(c['value']!.replaceFirst('#', '0xFF')));
